// /FluentUI/Controls/FluCopyableText.qml
...
namespace _0x5f_FluentUI_Controls_FluCopyableText_qml {
...
0xbc,0x13,0x0,0x0,0x37,0x37,0x33,0x32,
...
0x0,0x0,0x0,0x0,0xa1,0xa0,0x8a,0xcf,
0x77,0xfb,0xa1,0x29,0x8d,0xa4,0xd5,0x94,
0xa1,0xcb,0x2c,0x16,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0xc0,0x3,0x0,0x0,0x83,0x0,0x0,0x0,
0xd0,0x3,0x0,0x0,0xe3,0x3,0x0,0x0,
0xf0,0x3,0x0,0x0,0x83,0x2,0x0,0x0,
...
0x14,0x1,0xb,0xac,0x12,0x7,0x2,0xa,
...
0x1d,0x3c,0x1e,0x6e,0x7,0x50,0x9,0x2e,
...
// generate_GetLookup
while (!aotContext->getObjectLookup(3, r2_1, &r2_3)) {
...
;
// generate_GetLookup
while (!aotContext->getEnumLookup(10, &r2_3)) {
aotContext->setInstructionPointer(10);
...
label_0:;
// generate_GetLookup
while (!aotContext->getEnumLookup(12, &r2_3)) {
aotContext->setInstructionPointer(16);
...
aotContext->setInstructionPointer(4);
aotContext->initGetEnumLookup(24, []() { static const auto t = QMetaType::fromName("Qt"); return t; }().metaObject(), "CursorShape", "IBeamCursor");
if (aotContext->engine->hasError())
    return int();
}
// generate_Ret
...
aotContext->setInstructionPointer(4);
aotContext->initGetEnumLookup(26, []() { static const auto t = QMetaType::fromName("Qt"); return t; }().metaObject(), "MouseButton", "RightButton");
if (aotContext->engine->hasError())
    return int();
}
// generate_Ret
...
{
QObject * retrieved;
while (!aotContext->loadContextIdLookup(34, &retrieved)) {
aotContext->setInstructionPointer(2);
