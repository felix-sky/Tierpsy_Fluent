...
namespace _0x5f_FluentUI_Controls_FluScrollIndicator_qml {
...
0xf0,0x11,0x0,0x0,0x37,0x37,0x33,0x32,
...
aotContext->initGetObjectLookup(17, r2_1, []() { static const auto t = QMetaType::fromName("QQuickPalette*"); return t; }());
if (aotContext->engine->hasError())
    return QVariant();
}
// generate_GetLookup
...
aotContext->setInstructionPointer(4);
aotContext->initGetObjectLookup(25, r2_1, QMetaType::fromType<QObject *>());
if (aotContext->engine->hasError())
    return static_cast<QObject *>(nullptr);
}
// generate_Ret
